<template>
  <div>
    <el-form ref="ruleForm" :model="form" :rules="rules" label-width="100px">
      <el-form-item label="开房日期" prop="startTime">
        <el-date-picker
      ...
      <el-form-item label="入住天数" prop="time">
        <el-input-number v-model="form.time" :min="1" :max="dayLeaveTime" label="入住天数" />
      </el-form-item>
  ...
  methods: {
    ...
    async submit() {
      try {
        ...
        const { msg } = await this.postRequest('/housing/open_room/openDay', this.form)
